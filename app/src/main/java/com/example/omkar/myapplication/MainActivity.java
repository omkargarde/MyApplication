    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Hero temp=heroList.get(position);
               // Log.d("number",temp.getNumber());
                //Toast.makeText(MainActivity.this, temp.getNumber().toString(), Toast.LENGTH_LONG).show();

                //Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" + temp.getNumber()));
